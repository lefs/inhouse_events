...
Combustion.initialize! :action_controller, :active_record, :sprockets do
...
# External requests are disabled while allowing localhost.
# We allow connections to codeclimate.com for test coverage reports.
